...
const PrivacyPolicyPage = (props) => {
    ...
    return(
        <section className="page-section">
            ...
            <p>Thank you for choosing to be part of our community at Wizrd Inc. <b>("Company", "we", "us", "our")</b>. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at <a href="mailto:support@wizrd.org">support@wizrd.org</a>.</p>
            <p>When you visit our website wizrd.org (the <b>"Website"</b>), use our Facebook application, as the case may be (the <b>"App"</b>) and more generally, use any of our services (the <b>"Services"</b>, which include the Website and App), we appreciate that you are trusting us with your personal information. We take your privacy very seriously. In this privacy notice, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy notice that you do not agree with, please discontinue use of our Services immediately.</p>
            ...
            <p><b>This privacy notice applies to all information collected through our Services (which, as described above, includes our Website and App), as well as, any related services, sales, marketing or events.</b></p>
           <h4>TABLE OF CONTENTS</h4>
           <ol className="styled-ol privacy-table-index">
               <li>
                   <a href="#table-contents-1">WHAT INFORMATION DO WE COLLECT?</a>
               </li>
               <li>
                   <a href="#table-contents-2"> HOW DO WE USE YOUR INFORMATION?</a>
               </li>
               <li>
                   <a href="#table-contents-3">WILL YOUR INFORMATION BE SHARED WITH ANYONE?</a>
               </li>
               <li>
                   <a href="#table-contents-4"> WHO WILL YOUR INFORMATION BE SHARED WITH?</a>
               </li>
               <li>
                   <a href="#table-contents-5">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a>
               </li>
               <li>
                   <a href="#table-contents-6">HOW DO WE HANDLE YOUR SOCIAL LOGINS?</a>
               </li>
               <li>
                   <a href="#table-contents-7">HOW LONG DO WE KEEP YOUR INFORMATION?</a>
               </li>
               <li>
                   <a href="#table-contents-8">HOW DO WE KEEP YOUR INFORMATION SAFE?</a>
               </li>
               <li>
                   <a href="#table-contents-9">DO WE COLLECT INFORMATION FROM MINORS?</a>
               </li>
               <li>
                   <a href="#table-contents-10">WHAT ARE YOUR PRIVACY RIGHTS?</a>
               </li>
               <li>
                   <a href="#table-contents-11">CONTROLS FOR DO-NOT-TRACK FEATURES?</a>
               </li>
               <li>
                   <a href="#table-contents-12"> DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a>
               </li>
               <li>
                   <a href="#table-contents-13">DO WE MAKE UPDATES TO THIS NOTICE?</a>
               </li>
               <li>
                   <a href="#table-contents-14">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a>
               </li>
               <li>
                   <a href="#table-contents-15">HOW CAN YOU REVIEW, UPDATE OR DELETE THE DATA WE COLLECT FROM YOU?</a>
               </li>
           </ol>
           <div class="privacy-table-contents" id="table-contents-1">
               ...
               <p>The personal information that we collect depends on the context of your interactions with us and the Services, the choices you make and the products and features you use. The personal information we collect may include the following:</p>
                <p><b>Personal Information Provided by You.</b> We collect names; phone numbers; email addresses; mailing addresses; usernames; job titles; passwords; contact or authentication data; billing addresses; debit/credit card numbers; contact preferences; and other similar information.</p>
                <p><b>Payment Data.</b> We may collect data necessary to process your payment if you make purchases, such as your payment instrument number (such as a credit card number), and the security code associated with your payment instrument. All payment data is stored by stripe and paypal. You may find their privacy notice link(s) here: <a target="_blank" href="https://stripe.com/privacy">https://stripe.com/privacy</a> and <a href="https://www.paypal.com/us/webapps/mpp/ua/privacy-full" target="_blank">https://www.paypal.com/us/webapps/mpp/ua/privacy-full</a>.</p>
                <p><b>Social Media Login Data.</b> We may provide you with the option to register with us using your existing social media account details, like your Facebook, Twitter or other social media account. If you choose to register in this way, we will collect the information described in the section called <a href="#table-contents-6">"HOW DO WE HANDLE YOUR SOCIAL LOGINS"</a> below.</p>
                <p>All personal information that you provide to us must be true, complete and accurate, and you must notify us of any changes to such personal information.</p>

                <h4>Information collected through our App</h4>
                <p><i><b>In Short: </b>  We collect information regarding your geo-location, mobile device, push notifications, and Facebook permissions when you use our App.</i></p>
                <p>If you use our App, we also collect the following information:</p>
                <ul className="styled-ul">
                <li><i>Geo-Location Information.</i> We may request access or permission to and track location-based information from your mobile device, either continuously or while you are using our App, to provide certain location-based services. If you wish to change our access or permissions, you may do so in your device's settings.</li>
                ...
                <li><i>Push Notifications.</i> We may request to send you push notifications regarding your account or certain features of the App. If you wish to opt-out from receiving these types of communications, you may turn them off in your device's settings.</li>
                <li><i>Facebook Permissions.</i> We by default access your <a href="https://www.facebook.com/about/privacy/" target="_blank">Facebook</a> basic account information, including your name, email, gender, birthday, current city, and profile picture URL, as well as other information that you choose to make public. We may also request access to other permissions related to your account, such as friends, checkins, and likes, and you may choose to grant or deny us access to each individual permission. For more information regarding Facebook permissions, refer to the <a target="_blank" href="https://developers.facebook.com/docs/permissions/reference">Facebook Permissions Reference</a> page.</li>
            
                </ul>

           </div>
           <div class="privacy-table-contents" id="table-contents-2">
               ...
               <ul className="styled-ul">
                   ...
                   <li><b>To send you marketing and promotional communications.</b> We and/or our third-party marketing partners may use the personal information you send to us for our marketing purposes, if this is in accordance with your marketing preferences. For example, when expressing an interest in obtaining information about us or our Services, subscribing to marketing or otherwise contacting us, we will collect personal information from you. You can opt-out of our marketing emails at any time (see the <a href="#table-contents-10">"WHAT ARE YOUR PRIVACY RIGHTS"</a> below).</li>
                   ...
                   <li><b>For other business purposes.</b> We may use your information for other business purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Services, products, marketing and your experience. We may use and store this information in aggregated and anonymized form so that it is not associated with individual end users and does not include personal information. We will not use identifiable personal information without your consent.</li>
               </ul>
           ...
           <div class="privacy-table-contents" id="table-contents-3">
           ...
           <div class="privacy-table-contents" id="table-contents-4">
               ...
               <ul className="styled-ul">
                   ...
                   <li>
                       ...
                       Facebook advertising, Instagram advertising and Twitter advertising
                   </li>
                   <li>
                   ...
                   <li>
                       <b>User Commenting and Forums</b><br />
                       Disqus, Facebook Comments and Segment
                   </li>
                   <li>
           ...
           <div class="privacy-table-contents" id="table-contents-5">
           ...
           <div class="privacy-table-contents" id="table-contents-6">
           ...
           <div class="privacy-table-contents" id="table-contents-7">
           ...
           <div class="privacy-table-contents" id="table-contents-8">
           ...
           <div class="privacy-table-contents" id="table-contents-9">
               ...
               <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at <a href="mailto:support@wizrd.org">support@wizrd.org</a>.</p>
           </div>
           <div class="privacy-table-contents" id="table-contents-10">
               <h3>10. WHAT ARE YOUR PRIVACY RIGHTS?</h3>
               <p><i><b>In Short:</b>  In Short:  In some regions, such as the European Economic Area, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time.</i></p>
                <p>In some regions (like the European Economic Area), you have certain rights under applicable data protection laws. These may include the right (i) to request access and obtain a copy of your personal information, (ii) to request rectification or erasure; (iii) to restrict the processing of your personal information; and (iv) if applicable, to data portability. In certain circumstances, you may also have the right to object to the processing of your personal information. To make such a request, please use the <a href="#table-contents-15">contact details</a> provided below. We will consider and act upon any request in accordance with applicable data protection laws.</p>
                ...
                <p>If you have questions or comments about your privacy rights, you may email us at  <a href="mailto:support@wizrd.org">support@wizrd.org</a>.</p>
           ...
           <div class="privacy-table-contents" id="table-contents-11">
           ...
           <div class="privacy-table-contents" id="table-contents-12">
               ...
               <p><i><b>In Short:</b>  Yes, if you are a resident of California, you are granted specific rights regarding access to your personal information.</i></p>
                ...
                <table className="privacy-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>H. Audio, electronic, visual, thermal, olfactory, or similar informatio</td>
                ...
                <p>Wizrd Inc. collects and shares your personal information through:</p>
                <ul className="styled-ul">
                ...
                <p>You may contact us Mailing to 16192 Coastal Highway, Lewes, Delaware 19958, or by referring to the contact details at the bottom of this document.</p>
                ...
                <p>Wizrd Inc. has disclosed the following categories of personal information to third parties for a business or commercial purpose in the preceding twelve (12) months:</p>
                <ul className="styled-ul">
                ...
                <p>
                The categories of third parties to whom we disclosed personal information for a business or commercial purpose can be found under <a href="#table-contents-4">"WHO WILL YOUR INFORMATION BE SHARED WITH?"</a>.
                </p>
                <p>Wizrd Inc. has sold the following categories of personal information to third parties in the preceding twelve (12) months:</p>
                <ul className="styled-ul">
                    <li>Category B. Personal information, as defined in the California Customer Records law, such as your name, contact information, education, employment, employment history and financial information.</li>
                </ul>
                ...
                <p>To exercise these rights, you can contact us Mailing to 16192 Coastal Highway, Lewes, Delaware 19958, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</p>
           </div>
           <div class="privacy-table-contents" id="table-contents-13">
           ...
           <div class="privacy-table-contents" id="table-contents-14">
               <h3>14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h3>
               <p>If you have questions or comments about this notice, you may email us at support@wizrd.org or by post to:</p>
               <p>Wizrd Inc.<br/>
